...
def generate_launch_description():
   # main package path
  package_dir=get_package_share_directory('tracks_gazebo_worlds')
  # using package path to find urdf file
  urdf = os.path.join(package_dir,'Rehri_gazebo_rviz.urdf')
  # using package path to find the Custom World file
  world_file = os.path.join(package_dir,'my_track.world')
  # Adding path to gazebo_ros package
  pkg_gazebo_ros = get_package_share_directory('gazebo_ros')
  # Important rviz file to make life easy 
  rviz_config_file=os.path.join(package_dir,'rviz_config.rviz')
